...
class TechQA(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        if self.config.data_dir is not None and self.config.data_dir != "":
            ...
            if isinstance(data_dir, dict):
                assert len(data_dir) == 1, "Multiple files are not supported"
            ...
            if self.config.name == "full":
                ...
                for obj in data:
                    if self.config.answer_only and obj["ANSWERABLE"] != "Y":
                        # skip sample
                        continue
                    # currently use question title as title
                    ...
                    if obj["ANSWERABLE"] == "Y":
                        ...
                        # use random document for unanswerable questions
